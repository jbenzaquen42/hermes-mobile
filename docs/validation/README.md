...
Implementation is merged through Phase 6. The Windows development host could perform source,
...
- [ ] [Phase 6 — Automations](phase-6-automations.md) — implementation merged; validation pending
...
1. Implement Phase 7 Kanban.
2. Implement Phase 8 Notifications and polish.
3. Run Validation Phases 1–3 in order once the Mac is ready.
